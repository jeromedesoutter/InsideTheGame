...
namespace UnityStandardAssets.Characters.FirstPerson
{
    ...
    public class FirstPersonController : MonoBehaviour
    {
        ...
        private void FixedUpdate()
        {
            ...
            if (m_CharacterController.isGrounded && bounce == 0)
            {
        ...
        private void OnControllerColliderHit(ControllerColliderHit hit)
        {
            ...
            if (hit.collider.CompareTag("WitherSkull") && hit.collider.gameObject.GetComponent<WitherSkull>()!= null)
            {
                Debug.Log("sfefsefsf" + hit.collider.gameObject.name);
                hit.collider.gameObject.GetComponent<BoxCollider>().enabled = false;
                GetComponent<Player>().TakeDamage(hit.collider.gameObject.GetComponent<WitherSkull>().hitDamage);
            }
